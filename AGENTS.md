...
本子仓受主仓`../../AGENTS.md`约束。Agent从本目录启动时也必须先读取主仓规则。

## 强制规则

1. 所有测试相关内容放在主仓，目标位置通常是`../../tests/robobaton_4p_demo/`；本子仓不得新增`tests/`、fixture、fake、mutant、benchmark、板端validation runner或测试证据。
